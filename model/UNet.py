...
from model.custom_blocks import *

class UNet(nn.Module):

    def __init__(self, in_dim=3, classes=19, num_filter=64):
        ...
        self.bottle_neck = conv_block_2(self.num_filter*8, self.num_filter*16, act_fn)
    ...
    def forward(self, input):
        ...
        trans_1 = self.trans_1(bottle_neck)
