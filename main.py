...
def main():
    ...
    # transform = None
    print("train")
    train_data = get_cityscapes_data(mode='fine', split='train', num_workers = NUM_WORKERS, batch_size = 8, transforms = train_transform)
    val_transform = A.Compose([
    A.Resize(256, 512),
    A.Normalize(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)),
    ToTensorV2(),]) 
    val_data = get_cityscapes_data(mode='fine', split='val', num_workers = NUM_WORKERS, batch_size = 8, transforms = val_transform)
